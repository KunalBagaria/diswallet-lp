...
export const DefaultHead = function DefaultHead() {
  return (
    <Head>
      ...
      <meta property="og:url" content="https://diswallet.vercel.app/" />
      ...
      <meta property="twitter:url" content="https://diswallet.vercel.app/" />
      ...
      <meta property="twitter:image" content="https://i0.wp.com/c.tenor.com/K9XG-Ir3F0oAAAAd/bunny-rabbit.gif" />
    </Head>
  );
};
